...
def usageguide():
    print("InsecureBankv2 Backend-Server", file=sys.stdout)
    print("Options: ", file=sys.stdout)
    print("  --port p    serve on port p (default 8888)", file=sys.stdout)
    print("  --help      print this message", file=sys.stdout)
...
def login():
    ...
    print(makejson(data), file=sys.stderr)
...
def getaccounts():
    ...
    print(makejson(data), file=sys.stdout)
    return makejson(data)
...
if __name__ == '__main__':
    ...
    print("The server is hosted on port:",(port), file=sys.stderr)
